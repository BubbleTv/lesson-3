...
catalog = []
catalog.append(Smartphone("Ale", "iPhone 15 Pro", "+79123456789"))
catalog.append(Smartphone("Samsung", "Galaxy S24 Ultra", "+79234567890"))
catalog.append(Smartphone("Xiaomi", "Mi 14 Pro", "+79345678901"))
catalog.append(Smartphone("Google", "Pixel 9 Pro", "+79456789012"))
